...
---
# `{{Oturum Başlığı (YYYY-MM-DD)}}`

Girdi: `{{kaynak/istek — 1-2 satır}}`

Bağ: [[index]] · `[[{{ilgili-wiki-notu}}|{{Görünen Başlık}}]]`

## Kararlar
- `{{oturumda alınan kararlar — yoksa bölümü sil}}`

## Önemli sonuçlar
- `{{yapılan işler, bulunanlar — dosya yollarıyla}}`

## Değişen kurallar
- `{{AGENTS/SCHEMA/wiki policy değişiklikleri — yoksa bölümü sil}}`

## Follow-up'lar
- `{{açık kalan işler, insan aksiyonları}}`
